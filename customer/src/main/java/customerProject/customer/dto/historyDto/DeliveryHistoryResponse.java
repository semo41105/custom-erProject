...
public class DeliveryHistoryResponse{
    ...
    public DeliveryHistoryResponse(Long deliveryNo, Long orderNo, LocalDateTime orderDate, DeliveryStatus deliveryStatus, OrderStatus orderStatus, Address address) {
