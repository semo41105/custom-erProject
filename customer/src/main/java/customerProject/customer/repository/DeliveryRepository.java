...
public interface DeliveryRepository extends JpaRepository<Delivery, Long> {
    ...
    @Query("SELECT new customerProject.customer.dto.historyDto.DeliveryHistoryResponse2(d.no, o.no, o.date, d.deliveryStatus, o.status, d.address) FROM Delivery d JOIN d.orders o")
